...
const Public = () => {
  ...
  return (
    <div className=" h-screen bg-home flex flex-col">
      <div className="w-full h-full flex-auto flex relative">
        ...
        {isSidebarRight && (
          <div className="w-[330px] absolute bottom-0 right-0 top-0 z-50 bg-[#5d218c]">
            <SidebarRight />
          </div>
        )}
      </div>
      <div className="flex-none h-[90px] bg-slate-400 z-40">
        <Player />
      </div>
      <div
